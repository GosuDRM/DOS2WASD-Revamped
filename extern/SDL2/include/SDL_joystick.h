...
extern DECLSPEC int64_t SDLCALL SDL_JoystickGetXInputPlayerIndex(SDL_Joystick *joystick);

extern DECLSPEC int64_t SDLCALL SDL_JoystickGetDInputDeviceReference(SDL_Joystick *joystick);

extern DECLSPEC int64_t SDLCALL SDL_JoystickIsXInput(SDL_Joystick *joystick);
