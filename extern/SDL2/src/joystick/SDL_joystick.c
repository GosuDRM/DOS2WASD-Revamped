...
int64_t SDL_JoystickGetXInputPlayerIndex(SDL_Joystick *joystick)
{
    return SDL_JoystickGetPlayerIndex(joystick);
}

int64_t SDL_JoystickGetDInputDeviceReference(SDL_Joystick *joystick)
{
    return SDL_JoystickGetPlayerIndex(joystick);
}

int64_t SDL_JoystickIsXInput(SDL_Joystick *joystick)
{
    return 1;
}
