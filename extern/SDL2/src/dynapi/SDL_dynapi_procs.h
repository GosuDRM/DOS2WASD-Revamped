...
SDL_DYNAPI_PROC(int64_t,SDL_JoystickGetXInputPlayerIndex,(SDL_Joystick *a),(a),return)
SDL_DYNAPI_PROC(int64_t,SDL_JoystickGetDInputDeviceReference,(SDL_Joystick *a),(a),return)
SDL_DYNAPI_PROC(int64_t,SDL_JoystickIsXInput,(SDL_Joystick *a),(a),return)
