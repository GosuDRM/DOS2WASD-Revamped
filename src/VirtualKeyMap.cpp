...
void VirtualKeyMap::AddVkCombosForCommand(Command command, const std::vector<std::string>& keycombos)
{
...
bool VirtualKeyMap::VkIsValid(const std::string& keyname) { return GetVkByName(keyname) != 0; }
